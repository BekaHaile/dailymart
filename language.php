        ...
        <div class="card-body">
            ...
            <form action="#" method="post">
                <div class="language-area-wrapper py-3">
                    <ul>
                        <li>
                            <input id="English" type="radio" name="selector" value='en' <?php if($_SESSION['lang'] == 'en'){ ?> checked <?php } ?>>
                            <label for="English">English</label>

                            <div class="check"></div>
                        </li>
                        <li>
                            <input id="Afrikaans" type="radio" name="selector" value='am' <?php if($_SESSION['lang'] == 'am'){ ?> checked <?php } ?>>
                            <label for="Afrikaans">አማርኛ</label>
