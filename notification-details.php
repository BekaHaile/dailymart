...
$notif = find_notification_by_id($_GET["id"]);
$c_cart = null;
...
$query = "UPDATE [dbo].[notification] SET ";
$query .= "[status] = 1";
...
<div class="header-area" id="headerArea">
    <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Back Button-->
        <div class="back-button"><a href="notifications.php"><i class="lni lni-arrow-left"></i></a></div>
        <!-- Page Title-->
...
<div class="page-content-wrapper">
    <div class="container">
        ...
        <div class="notification-area pt-3 pb-2">
            ...
            <div class="list-group-item d-flex py-3 <?php echo ($notif["status"] == 1)?"readed":"";?>">
                <span class="noti-icon"><i class="lni lni-alarm"></i></span>

                <div class="noti-info">
                    <h6><?php echo $notif["title"]; ?></h6>

                    <p><?php echo $notif["description"]; ?></p>
                </div>
            </div>
        </div>
    </div>
