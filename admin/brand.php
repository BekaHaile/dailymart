        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">All Category 3 List</h2>
                </header>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        <?php
                        $k = 1;
                        while ($row = sqlsrv_fetch_array($brand, SQLSRV_FETCH_ASSOC)) {
                            $category = find_category_by_cat_id(find_product_group_by_pro_id($row["product_id"])["category_id"]);
                            ...
                            <tr class="">
                                ...
                                <td class="actions">
                                    ...
                                    <a href="editBrand.php?id=<?php echo urldecode($row["id"]); ?>"
                                       class="on-default edit-row"><i class="fa fa-pencil"></i></a>
                                    <a href="deleteCategory3.php?id=<?php echo $row["id"] . ''; ?>"
