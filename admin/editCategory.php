...
if (isset($_POST["submit"])) {
    if (isset($_POST["cat"])) {
        ...
        $id = $cat["id"];
        $image = upload_image_with_title($cat["category_id"], "image");

        if (empty($image)) {
            $image = $cat["image"];
			$query = "UPDATE [dbo].[category] SET ";
			$query .= "[image] = NULL ";
			$query .= "WHERE [id] = '{$id}'; ";
        ...
        if ($result) {
            // Success
            //$_SESSION["art_message"] = "Successfully Updated". $query;
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Edit Category 1</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select name="cat" data-plugin-selectTwo class="form-control populate" required>
                                    <option
                                        value="<?php echo $cat["id"] ?>"><?php echo $cat["title_en"] . "/ " . $cat["title_am"]; ?></option>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Category 1 Image</label>
