                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        while ($row = sqlsrv_fetch_array($slider, SQLSRV_FETCH_ASSOC)) {
                            ...
                            <tr>
                                <td><?php echo $k++; ?></td>
                                <td><?php echo ($row["created_for"] == "Home Page") ? $row["created_for"] : find_category_by_cat_id($row["created_for"])["title_en"] . " / " . find_category_by_cat_id($row["created_for"])["title_am"]; ?></td>
                                <td><img src="<?php echo $row["image"]; ?>" style="height: 50px;width: auto"></td>
                                ...
                                <td class="actions">
                                    ...
                                    <!--                                    <a href="editTendersCategory.php?id=-->
