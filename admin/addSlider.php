...
<?php
$cat = find_all_Category_no_image();
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Slider Type</label>

                            <div class="col-lg-4">
                                <select name="type" data-plugin-selectTwo class="form-control populate" required>
                                    ...
                                    while ($row = sqlsrv_fetch_array($cat, SQLSRV_FETCH_ASSOC)) {
                                        ?>
                                        <option
                                            value="<?php echo $row["category_id"] ?>"><?php echo $row["title_en"] . "/ " . $row["title_am"]; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2">Slider Image</label>
