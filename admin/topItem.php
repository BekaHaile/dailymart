        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">All Top Product List</h2>
                </header>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                        ...
                        while ($row = sqlsrv_fetch_array($item, SQLSRV_FETCH_ASSOC)) {
                            ...
                            <tr class="">
                                <td><?php echo $k++; ?></td>
                                <td><?php echo find_item_by_item_id($row["item_id"])["item_id"]; ?></td>
                                <td><?php echo find_item_by_item_id($row["item_id"])["title_en"]; ?></td>
                                <td class="actions">
...
<!--										class="on-default edit-row"><i class="fa fa-pencil"></i></a>-->
                                    <a href="deleteCategory.php?id=<?php echo $row["id"] . ''; ?>"
										onclick="return confirm('Are you sure?');" class="on-default remove-row">
