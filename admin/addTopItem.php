        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Create Top Product</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select name="item" data-plugin-selectTwo class="form-control populate" required>
                                    <option value="">Select Item</option>
                                    <?php
                                    while ($row = sqlsrv_fetch_array($item, SQLSRV_FETCH_ASSOC)) {
                                        ?>
                                        <option
                                            value="<?php echo $row["item_id"] ?>"><?php echo $row["title_en"] . "/ " . $row["title_am"]; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
