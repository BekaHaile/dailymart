...
$category = find_category_by_id(find_product_group_by_id($cat["product_id"])["category_id"]);
$pro = find_product_group_by_id($cat["product_id"]);

if (isset($_POST["submit"])) {
    if (isset($_POST["brand"])) {

        $id = $cat["id"];
        $image = upload_image_with_title($cat["brand_id"], "image");

        if (empty($image)) {
            $image = $cat["image"];
			$query = "UPDATE [dbo].[brand] SET ";
			$query .= "[image] = NULL ";
			$query .= "WHERE [id] = '{$id}'; ";
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Edit Category 3</h2>
                </header>
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select disabled name="cat" readonly data-plugin-selectTwo class="form-control populate"
                                        required>
                                    <option
                                        value="<?php echo $category["id"] ?>"><?php echo $category["title_en"] . "/ " . $category["title_am"]; ?>
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select disabled name="pro" readonly data-plugin-selectTwo class="form-control populate"
                                        required>
                                    <option value="<?php echo $pro["id"] ?>">
                                        <?php echo $pro["title_en"] . "/ " . $pro["title_am"]; ?>
                                    </option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select name="brand" readonly="readonly" data-plugin-selectTwo
