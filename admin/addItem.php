                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-4">
                                <select name="item" id = "item" data-plugin-selectTwo class="form-control populate" required>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2"
                                   for="textareaDefault">Specification English </label>

                            <div class="col-lg-4">
                                <textarea class="form-control" name="specen"></textarea>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2"
                                   for="textareaDefault">Specification Amharic</label>

                            <div class="col-lg-4">
                                <textarea class="form-control" name="specam"></textarea>
