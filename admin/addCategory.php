...
if (isset($_POST["submit"])) {
    if (isset($_POST["cat"])) {
        ...
        create_Category($cat, $image, $user);
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Create Category 1</h2>
                </header>
                <div class="card-body">
                            ...
                            <div class="col-lg-4">
                                <select name="cat" data-plugin-selectTwo class="form-control populate" required>
                                    ...
                                    while ($row = sqlsrv_fetch_array($cat, SQLSRV_FETCH_ASSOC)) {
                                        ?>
                                        <option
                                            value="<?php echo $row["code"] ?>"><?php echo $row["catagory_description"] . "/ " . $row["amharic_name"]; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
