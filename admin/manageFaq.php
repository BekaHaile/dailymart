...
if (isset($_POST["submit"])) {
    if (isset($_POST["title"]) && isset($_POST["description"])) {
        ...
        $query = "INSERT INTO [dbo].[faq]([title] ,[description]) VALUES('$title','$description')";

        $result = sqlsrv_query($connection, $query);

        if ($result) {
            // Success
            $_SESSION["art_message"] = "Successfully Saved";

            redirect_to("faq.php");

        } else {
            // Failure
            $_SESSION["art_error"] = "Saving failed.";
        }

        } 
        else {

            $query = "UPDATE [dbo].[faq] SET title='$title', description = '$description' where id = '$id'";
        ...
        <div class="col">
            <section class="card">
                <header class="card-header">
                    ...
                    <h2 class="card-title">Post FAQ</h2>
                </header>
                <div class="card-body">
                ...
                if($_GET['type'] == "edit"){
                    ...
                    while ($row = sqlsrv_fetch_array($faq, SQLSRV_FETCH_ASSOC)) {
                        $editTitle = $row['title'];
                    ...
                    <form class="form-horizontal form-bordered" action="#" method="post" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-2 control-label text-lg-right pt-2"
                                   for="textareaDefault">Title </label>

                            <div class="col-lg-4">
                                <textarea class="form-control"
                                          name="title"><?php echo $editTitle?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <textarea class="summernote" data-plugin-summernote name="description"
                                          data-plugin-options='{ "height": 280, "codemirror": { "theme": "ambiance" } }'><?php echo $editDescription?></textarea>
                            </div>
                ...
                else 
                {
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10">
                            <textarea class="summernote" data-plugin-summernote name="description"
                                    data-plugin-options='{ "height": 280, "codemirror": { "theme": "ambiance" } }'></textarea>
                        </div>
