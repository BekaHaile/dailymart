...
<div class="header-area" id="headerArea">
    <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
            <h6 class="mb-0"><?php echo $lang['notifications']; ?></h6>
        </div>
        <!-- Navbar Toggler-->
...
<div class="page-content-wrapper">
    <div class="container">
        ...
        <div class="notification-area pt-3 pb-2">
            <h6 class="pl-1"><?php echo $lang['notifications']; ?></h6>

            <div class="list-group">
                <?php while ($row = sqlsrv_fetch_array($notif, SQLSRV_FETCH_ASSOC)) { ?>
                    <!-- Single Notification-->
                    <a class="list-group-item <?php echo ($row["status"] == 1) ? "readed" : ""; ?> d-flex align-items-center"
                       href="notification-details.php?id=<?php echo $row["id"]; ?>"><span class="noti-icon"><i
                                class="lni lni-alarm"></i></span>

                        <div class="noti-info">
                            <h6 class="mb-0"><?php echo $row["title"]; ?></h6>
                            <span><?php echo $row['date_time']->format('Y-m-d H:i:s'); ?></span>
                        </div>
                    </a>
                <?php } ?>
