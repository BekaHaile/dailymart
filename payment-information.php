...
<div class="header-area" id="headerArea">
    <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
            <h6 class="mb-0"><?php echo $lang['billingInformation']; ?></h6>
        </div>
        <!-- Navbar Toggler-->
        ...
        <div class="checkout-wrapper-area py-3">
            ...
            <div class="billing-information-card mb-3">
                <div class="card billing-information-title-card bg-success">
                    <div class="card-body">
                        <h6 class="text-center mb-0 text-white"><?php echo $lang['billingInformation']; ?></h6>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-user"></i><span><?php echo $lang['deliverFromShop']; ?></span></div>
                            <div
                                class="data-content">
									<?php 
						...
						<div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-user"></i><span><?php echo $lang['numberOfItem']; ?></span></div>
                            <div
                                class="data-content"><?php echo $_GET["total"]." items"; ?></div>
                        </div>
						<div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-user"></i><span><?php echo $lang['totalAmount']; ?></span></div>
                            <div
                                class="data-content"><?php echo number_format($_GET["amount"],2) . " ETB"; ?></div>
                        </div>
						<div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-user"></i><span><?php echo $lang['orderType']; ?></span></div>
                            <div
                                class="data-content"><?php echo $_GET["type"]; ?></div>
                        </div>
						<div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-user"></i><span><?php echo $lang['dateTime']; ?></span></div>
                            <div
                                class="data-content"><?php echo $_GET["CDdate"]." /".$_GET["CDtime"]; ?></div>
                        </div>
                        <div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i class="lni lni-phone"></i><span><?php echo $lang['phone']; ?></span>
                            </div>
                            <div class="data-content"><?php echo $user["mobile_number"]; ?></div>
                        </div>
                        <div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-cart"></i><span><?php echo $lang['invoiceToName']; ?></span>
                            </div>
                        ...
                        <div class="single-profile-data d-flex align-items-center justify-content-between">
                            <div class="title d-flex align-items-center"><i
                                    class="lni lni-cart"></i><span><?php echo $lang['tinNumber']; ?></span>
                            </div>
                        ...
                        <div class="single-profile-data d-flex align-items-center justify-content-between"
                            ...
                            <button type="button" class="btn btn-warning"
                                    ...
                                    <?php echo $lang['confirmInformation']; ?>
                            </button>
